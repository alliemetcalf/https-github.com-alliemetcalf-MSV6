    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-6">
            ...
            {isEditing ? (
                ...
                <div className="space-y-4">
                  ...
                  {editedProfile?.user_type === 'host' && (
                    <div>
                      ...
                      <MarkdownEditor
                        value={editedProfile?.about_host || ''}
                        onChange={(value) => handleInputChange('about_host', value)}
              ...
              <>
                ...
                {profile.user_type === 'host' && profile.about_host && (
                  <div>
                    <h2 className="text-lg font-semibold text-gray-900 mb-2">About {profile.preferred_name || profile.first_name} as a Host</h2>
                    <div className="prose prose-sm">
                      <ReactMarkdown remarkPlugins={[remarkGfm]}>
                        {profile.about_host}
                      </ReactMarkdown>
          ...
          {isEditing ? (
            <div className="mt-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Introduction Video</h2>
              <VideoUploader
                currentVideoUrl={profile.new_video_url}
                userId={profile.id}
                onVideoUpdate={(url) => {
            ...
            <div className="mt-6">
              ...
              <DeleteVideoButton
                videoUrl={profile.new_video_url}
                userId={profile.id}
                onVideoDeleted={() => {
                  setProfile(prev => prev ? {
                    ...prev,
